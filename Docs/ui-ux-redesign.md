...
| Area | Result |
| --- | --- |
| Today | Current capture and next meeting lead; three personal actions link to the complete review; brief details are collapsed; generation and capture timestamps are distinct. |
