...
- **Transcribes locally.** Qwen3-ASR 1.7B by default; Parakeet for speed (up to ~190× realtime in local benchmarks), Whisper for 99 languages, and IBM Granite Speech 4.1 as another local option.
