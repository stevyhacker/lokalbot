...
PAGES = [
    {
        ...
        "description": 'Granola is a polished cloud AI notepad. LokalBot keeps the bot-free workflow but runs transcription and summaries on your Mac by default — no account, free and GPLv3.',
