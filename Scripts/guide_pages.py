...
<span class="c-prompt">$</span> xcodegen generate <span class="c-op">&amp;&amp;</span> open LokalBot.xcodeproj</pre>
    ...
    },
    {
        ...
        <h2 id="first-memory">Set up your work memory</h2>
        <ol>
          ...
          <li>Open LokalBot from Applications and finish the model downloads for the features you want to use. Keep an internet connection for this initial setup.</li>
          <li>Review recording and screen-context settings before granting capture permissions.</li>
          <li>Enable the features you want and grant their required macOS permissions. Save a useful moment, or explore the activity you have chosen to capture in Timeline.</li>
          <li>Enable Quick Recall and search for something from that context. Use Today to review your day digest as your local library grows.</li>
        </ol>

        <h3 id="first-meeting">Try meeting capture</h3>
        <p>Meetings are another source for your work memory. Before relying on recording:</p>
        <ol>
          <li>Confirm the microphone and system-audio permissions, then make a short recording in your meeting application with participant consent.</li>
