...
enum CotypingAXHelper {
    ...
    static let cacheState = CacheState()
    ...
    /// NSAttributedString exposes run attributes as heterogeneous values.
    private static func extractFieldStyle(from attributes: [NSAttributedString.Key: Any]) -> CotypingFieldStyle? { // swiftlint:disable:this no_dynamic_any
        var fontName: String?
        var fontPointSize: CGFloat?
        if let font = attributes[.font] as? NSFont {
            fontName = font.fontName
            fontPointSize = font.pointSize
        // Accessibility represents font metadata as an untyped dictionary.
        } else if let fontInfo = attributes[NSAttributedString.Key("AXFont")] as? [String: Any] { // swiftlint:disable:this no_dynamic_any
    ...
    /// NSAttributedString exposes run attributes as heterogeneous values.
    private static func colorAttribute(in attributes: [NSAttributedString.Key: Any], // swiftlint:disable:this no_dynamic_any
