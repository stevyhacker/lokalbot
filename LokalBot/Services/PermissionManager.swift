...
/// The exactly three macOS privacy permissions LokalBotV3 needs. System-audio
...
/// Single source of truth for LokalBotV3's permission state.
///
...
final class PermissionManager: ObservableObject {
    ...
    /// Re-launches LokalBotV3. Accessibility grants only take effect at process
