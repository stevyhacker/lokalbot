...
/// The exactly three macOS privacy permissions BotinaV2 needs. System-audio
...
/// Single source of truth for BotinaV2's permission state.
///
...
final class PermissionManager: ObservableObject {
    ...
    /// Re-launches BotinaV2. Accessibility grants only take effect at process
