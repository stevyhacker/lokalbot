...
struct CommandPaletteView: View {
    ...
    private var results: [PaletteItem] {
        ...
        let actions: [PaletteItem] = [
            ...
            .init(id: "nav.actions", icon: "checklist", title: "Review all actions",
                  subtitle: "Today", action: { app.openActions() }),
