        ...
        VStack(alignment: .leading, spacing: 18) {
            HStack(spacing: 12) {
                ...
                VStack(alignment: .leading, spacing: 2) {
                    Text("Welcome to LokalBotV1").font(.title2.bold())
            ...
            Divider()
            HStack {
                Label("If a permission was granted while LokalBotV1 was running, relaunch to apply it.",
                      systemImage: "arrow.triangle.2.circlepath")
                    .font(.caption).foregroundStyle(.secondary)
                Spacer()
                Button("Relaunch LokalBotV1") { PermissionManager.relaunch() }
